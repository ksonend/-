...
var
  Form3: TForm3;
      s,p,pol,opr_vid,vid_pered_1, vid_pered_2:integer;
...
begin
     ...
     s:=2; // определяет место цветка при выходе
    ...
    1,2:begin    image2.imageindex:= shkal_rast_2;
              ...
              if  vhod_2=0 // для входа и начала растения- картинка
               then begin Form10.Image8.ImageIndex:=4; vhod_2:=1; end; end;
    3,4: begin  image3.imageindex:= shkal_rast_2;
              Form10.Image3.Show;
                if  vhod_2=0 // для входа и начала растения- картинка
               then begin Form10.Image8.ImageIndex:=4; vhod_2:=1; end;end;
      end;
...
begin
    // посаженое семя 1 и переход на выращ
     s:=1; // определяет место цветка при выходе
